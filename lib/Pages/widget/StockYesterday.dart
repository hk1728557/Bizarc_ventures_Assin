...
class StockYesterday extends StatefulWidget {
  const StockYesterday({super.key});

  @override
  State<StockYesterday> createState() => _StockYesterdayState();
}

class _StockYesterdayState extends State<StockYesterday> {
  @override
